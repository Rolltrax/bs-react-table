module ReactTable = {
  ...
  let make =
      (
        ...
        ~showPageSizeOptions: option(Js.boolean)=?,
        ~pageSizeOptions: option(array(int))=?,
        ~defaultPageSize: option(int)=?,
        ~minRows: option(int)=?,
        ~showPageJump: option(Js.boolean)=?,
        ~collapseOnSortingChange: option(Js.boolean)=?,
        ~collapseOnPageChange: option(Js.boolean)=?,
        ~collapseOnDataChange: option(Js.boolean)=?,
        ~freezeWhenExpanded: option(Js.boolean)=?,
        ~sortable: option(Js.boolean)=?,
        ~multiSort: option(Js.boolean)=?,
        ~resizable: option(Js.boolean)=?,
        ~filterable: option(Js.boolean)=?,
        ~defaultSortDesc: option(Js.boolean)=?,
        ...
        ~defaultFilterMethod:
           option((Js.t({..}), Js.t({..}), Js.t({..})) => Js.boolean)=?,
        ~defaultSortMethod:
           option((Js.t({..}), Js.t({..}), Js.boolean) => int)=?,
